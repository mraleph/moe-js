...
$$.main_anon1 = {"": [],
 ...
 call$1: function(e) {
  ...
  a = $.AnchorElement_AnchorElement($);
  a.set$href(t1);
  $.indexSet(a.get$attributes(), 'download', $.query('#name').get$value());
 ...
 call$0: function() {
  ...
  for (; $.ltB(y, this.height_7); ++y)
    for (t2 = t3.length, x = 0; x < t1; ++x) {
      ...
      t4 = t3[y];
      if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior()))
        return this.call$0$bailout1(3, t1, y, t3, t4, x);
      if (x >= t4.length)
        throw $.ioore(x);
      if (!(t4[x] === '|')) {
        if (x >= t4.length)
...
$$.parseASCIIArt_extractLine = {"": ["toColor_19", "dir_18", "findLineChar_17", "erase_16", "figures_15", "isPartOfLine_14", "data_13", "isLineEnding_12"],
 ...
 call$0: function() {
  ...
  x1 = ch.get$x();
  if (typeof x1 !== 'number')
    return this.call$0$bailout0(3, start, x0, y0, x1, t3, t1, color, t2, ch, d, t4);
  y1 = ch.get$y();
  if (typeof y1 !== 'number')
    return this.call$0$bailout0(4, start, x0, y0, x1, t3, y1, color, t2, d, t1, t4);
  while (true) {
    t5 = d.get$x();
    if (typeof t5 !== 'number')
      throw $.iae(t5);
 ...
 call$0: function() {
  ...
  for (; $.ltB(y, this.height_21); ++y)
    for (x = 0; x < t1; ++x) {
      ...
      t2 = t3[y];
      if (typeof t2 !== 'string' && (typeof t2 !== 'object' || t2 === null || t2.constructor !== Array && !t2.is$JavaScriptIndexingBehavior()))
        return this.call$0$bailout(4, t5, x, t1, y, t3, t2);
      if (x < 0 || x >= t2.length)
        throw $.ioore(x);
      if (!(t2[x] === ' ')) {
        end = x;
...
$$._convertDartToNative_PrepareForStructuredClone_walk = {"": ["writeSlot_8", "readSlot_7", "findSlot_6"],
 ...
 call$1: function(e) {
  ...
  if (typeof e === 'object' && e !== null && (e.constructor === Array || e.is$List())) {
      ...
      for (i = 0; i < length$; ++i) {
        ...
        if (!(elementCopy == null ? element == null : elementCopy === element)) {
          ...
          if (typeof copy !== 'object' || copy === null || (copy.constructor !== Array || !!copy.immutable$list) && !copy.is$JavaScriptIndexingBehavior())
            return this.call$1$bailout0(2, e, t3, elementCopy, i, length$, copy, slot);
    ...
    if (typeof copy !== 'object' || copy === null || (copy.constructor !== Array || !!copy.immutable$list) && !copy.is$JavaScriptIndexingBehavior())
      return this.call$1$bailout0(3, copy, e, length$, i);
    for (; i < length$; ++i) {
      if (i >= e.length)
        throw $.ioore(i);
      t1 = this.call$1(e[i]);
  ...
  for (y = 0; y < height; ++y) {
    ...
    for (x = line.length, x0 = 0; x0 < x; ++x0) {
      ...
      if (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array || !!t1.immutable$list) && !t1.is$JavaScriptIndexingBehavior())
        return $.parseASCIIArt$bailout(4, t1, y, width, x0, line, data);
      t4 = line[x0];
      if (x0 >= t1.length)
        throw $.ioore(x0);
      t1[x0] = t4;
    ...
    for (; x < width; ++x) {
      t1 = data[y];
      if (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array || !!t1.immutable$list) && !t1.is$JavaScriptIndexingBehavior())
        return $.parseASCIIArt$bailout(5, y, t1, x, width, data);
      if (x >= t1.length)
        throw $.ioore(x);
      t1[x] = ' ';
    }
